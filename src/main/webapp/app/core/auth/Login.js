            ...
            <div className={classes.main}>
                <Card className={classes.card}>
                    <div className={classes.actions}>
                        <GoogleLoginButton onClick={() => location.href = GOOGLE_AUTH_URL} size='39px'
                                           style={{fontSize: "14px", fontFamily: "Arial"}}/>
                    </div>


                    <form onSubmit={handleSubmit(this.login)}>
                        <div className={classes.hint}>OR</div>
                        <div className={classes.hint}>Hint: admin@localhost / admin</div>
