        ...
        {controllerProps => (
            <ShowView {...props} {...controllerProps}>
                <SimpleShowLayout>
                    ...
                    <ImageField addLabel={false} source="smallImageUrl" label="resources.booksPublic.fields.smallImageUrl"/>
                    {controllerProps.record && (controllerProps.record['isbn'] != null || controllerProps.record['isbn13'] != null)  &&
                        ...
                        >
                            <Datagrid>
                                <CompactListActionsToolbar source="rating" label="resources.booksPublic.referenceManyFields.comment.rating">
                                    <StarRatingField/>
                                </CompactListActionsToolbar>
                                <AvatarField size={40} source="createdBy.imageUrl" label="resources.booksPublic.referenceManyFields.comment.createdBy.imageUrl"/>
                                <TextField source="createdBy.name" label="resources.booksPublic.referenceManyFields.comment.createdBy.name"/>
