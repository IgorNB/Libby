                    ...
                    >
                        <Datagrid>
                            <CompactListActionsToolbar source="rating"
                                                       label="resources.books.referenceManyFields.comment.rating">
                                <StarRatingField/>
                            </CompactListActionsToolbar>
                            <AvatarField size={40} source="createdBy.imageUrl"
                                         label="resources.books.referenceManyFields.comment.createdBy.imageUrl"/>
                            <TextField source="createdBy.name"
                                       label="resources.books.referenceManyFields.comment.createdBy.name"/>
