        ...
        <Responsive
            ...
            medium={
                <Datagrid rowClick={rowClick}>
                    <ReferenceField source="assignee.id" reference="users" label="resources.tasks.fields.assignee.name"
                                    allowEmpty>
                        <TextField source="name"/>
                    </ReferenceField>
                    <ReferenceField source="createdBy.id" reference="users"
                                    label="resources.tasks.fields.createdBy.name" allowEmpty>
                        <TextField source="name"/>
                    </ReferenceField>
                    <TaskStatusColor source="workflowStep" label="resources.tasks.fields.workflowStep"/>
                    <ReferenceField source="book.id" reference="books" label="resources.tasks.fields.book.title"
                                    allowEmpty>
                    ...
                    <TextField source="bookIsbn13" label="resources.tasks.fields.bookIsbn13"
                               cellClassName={classes.title}/>
                    <TextField source="bookOriginalTitle" label="resources.tasks.fields.bookOriginalTitle"/>
                    <ReferenceField label="Lang" label="resources.tasks.fields.bookLang.code" source="bookLang.id"
                                    reference="langs" allowEmpty>
