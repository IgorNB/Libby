            ...
            {({resource, record, redirect, save, basePath, version}) => (
                <div className="edit-page">
                    ...
                    <Card className={classes.card}>
                        {record && (
                            <SimpleForm basePath={basePath} redirect={redirect} resource={resource} record={record}
                                ...
                                <ReferenceInput source="book.id" reference="books"
                                                perPage={15} sort={{field: 'title', order: 'ASC'}} fullWidth
                                ...
                                <LongTextInput source="body" validate={minLength(10)} fullWidth
                                               label="resources.comments.fields.body"/>
                            </SimpleForm>
                        )}
                    </Card>
                </div>
